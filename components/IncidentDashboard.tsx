  ...
  return (
    <div className="w-full bg-alesvia-surface/80 border border-alesvia-muted/20 rounded-2xl overflow-hidden shadow-2xl relative">
      ...
      <div className="hidden lg:block overflow-x-auto">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-alesvia-muted/10 text-sm">
            {incidents === undefined ? (
              <tr>
                <td colSpan={5} className="p-8 text-center text-alesvia-muted">
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <span>Loading live incidents...</span>
                  </div>
                </td>
              </tr>
            ) : incidents.length === 0 ? (
              <tr>
                <td colSpan={5} className="p-8 text-center text-alesvia-muted">No incidents found.</td>
              </tr>
      ...
      <div className="lg:hidden divide-y divide-alesvia-muted/10">
        {incidents === undefined ? (
          <div className="p-8 text-center text-alesvia-muted flex items-center justify-center gap-3">
            <svg className="animate-spin h-5 w-5 text-alesvia-accent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
              <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
            </svg>
          ...
          <div className="p-8 text-center text-alesvia-muted">No incidents found.</div>
        ) : incidents.map((incident, idx) => (
